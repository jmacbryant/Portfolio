package src.com.badlogic.audio.samples.part7;
...
import src.com.badlogic.audio.analysis.ThresholdFunction;
...
{
	public static final String FILE = "samples/FlyBy (Cut and Fade).mp3";
